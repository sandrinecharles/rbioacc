...
namespace model_complexTK_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_complexTK");
    reader.add_event(207, 205, "end", "model_complexTK");
    return reader;
}
#include <stan_meta_header.hpp>
class model_complexTK
  : public stan::model::model_base_crtp<model_complexTK> {
private:
        int lentp;
        vector_d tp;
        int n_exp;
        ...
        vector_d vtdep;
public:
    model_complexTK(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_complexTK_namespace::model_complexTK";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "Cobs", "vector_d", context__.to_vec(lentp));
            Cobs = Eigen::Matrix<double, Eigen::Dynamic, 1>(lentp);
            vals_r__ = context__.vals_r("Cobs");
            pos__ = 0;
            size_t Cobs_j_1_max__ = lentp;
            ...
            context__.validate_dims("data initialization", "Cmet", "matrix_d", context__.to_vec(lentp,n_met));
            Cmet = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(lentp, n_met);
            vals_r__ = context__.vals_r("Cmet");
            pos__ = 0;
            size_t Cmet_j_2_max__ = n_met;
            size_t Cmet_j_1_max__ = lentp;
            for (size_t j_2__ = 0; j_2__ < Cmet_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < Cmet_j_1_max__; ++j_1__) {
                    Cmet(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            context__.validate_dims("data initialization", "Gobs", "vector_d", context__.to_vec(lentp));
            Gobs = Eigen::Matrix<double, Eigen::Dynamic, 1>(lentp);
            vals_r__ = context__.vals_r("Gobs");
            pos__ = 0;
            size_t Gobs_j_1_max__ = lentp;
            for (size_t j_1__ = 0; j_1__ < Gobs_j_1_max__; ++j_1__) {
                Gobs(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int t = (rankacc + 1); t <= lentp; ++t) {
                ...
                stan::model::assign(CGpred, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            ((C0 - (get_base1(R, t, "R", 1) * (1 - stan::math::exp((E + M))))) * stan::math::exp((-((E + M)) * get_base1(tp, t, "tp", 1)))), 
                            "assigning variable CGpred");
            ...
            for (int t = 1; t <= rankacc; ++t) {
                ...
                lp_accum__.add(normal_log(get_base1(Cobs, t, "Cobs", 1), get_base1(CGpred, t, 1, "CGpred", 1), sigmaCpred));
                current_statement_begin__ = 135;
                for (int i = 1; i <= n_met; ++i) {
                    current_statement_begin__ = 136;
                    lp_accum__.add(normal_log(get_base1(Cmet, t, i, "Cmet", 1), get_base1(Cmetpred, t, "Cmetpred", 1), get_base1(sigmaCmetpred, i, "sigmaCmetpred", 1)));
                }
            }
            ...
            if (as_bool(logical_eq(n_out, 2))) {
                ...
                for (int t = 1; t <= lentp; ++t) {
                    ...
                    lp_accum__.add(normal_log(get_base1(Gobs, t, "Gobs", 1), get_base1(CGpred, t, 2, "CGpred", 1), sigmaGpred));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_complexTK_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_complexTK_namespace::model_complexTK stan_model;
#ifndef USING_R
